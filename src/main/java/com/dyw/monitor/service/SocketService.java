...
import static com.dyw.monitor.controller.EgciController.equipmentEntitySet;
...
//                        logger.info("设备状态正在查询");
//                        break;
//                    }
//                    List<EquipmentEntity> equipmentEntityList = new ArrayList<>();
//                    switch (mess.substring(2)) {
//                        case "0":
//                            equipmentEntityList = getStatus(Egci.equipmentEntityList, 0);
//                            break;
//                        case "1":
//                            equipmentEntityList = getStatus(Egci.equipmentEntityList, 1);
//                            break;
//                        case "2":
//                            equipmentEntityList = getStatus(Egci.equipmentEntityList, 2);
//                            break;
//                        case "3":
//                            equipmentEntityList = getStatus(Egci.equipmentEntityList, 3);
//                            break;
//                    }
                    //返回消息给客户端
                    sendToClient(socketInfo, br, JSON.toJSONString(equipmentEntitySet));
