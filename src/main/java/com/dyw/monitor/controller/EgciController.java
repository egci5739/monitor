package com.dyw.monitor.controller;


import com.dyw.monitor.HCNetSDK;
import com.dyw.monitor.entity.ConfigEntity;
import com.dyw.monitor.entity.EquipmentEntity;
import com.dyw.monitor.handler.AlarmHandler;
import com.dyw.monitor.service.*;
import com.dyw.monitor.timer.AlarmTimer;
import com.dyw.monitor.timer.DeviceTimeSynchronizationTimer;
import com.dyw.monitor.timer.SynchronizationTimer;
import com.dyw.monitor.tool.Tool;
...
public class EgciController {
    ...
    public void initServer() {
        ...
        //获取全部设备状态
        Thread thread = new EquipmentStatusService();
        thread.start();
        //获取设备网络状态
        int count = 0;
